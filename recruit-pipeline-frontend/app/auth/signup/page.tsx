...
export default function SignupPage() {
  ...
  return (
    <div className="relative w-screen h-screen flex justify-center items-center overflow-hidden">
      ...
      <div className='w-[95%] sm:w-[70%] md:w-[40%] h-auto py-10 bg-violet-400/20 bg-opacity-30 rounded-lg backdrop-blur-md flex flex-col items-center shadow-lg'>
        ...
        <form className='w-[80%] mt-5 flex flex-col gap-4 text-zinc-800' onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="w-full p-2 bg-violet-700 text-white rounded-lg hover:bg-violet-800 transition-colors font-semibold mt-2"
          >
            Sign Up
          </button>
        </form>
